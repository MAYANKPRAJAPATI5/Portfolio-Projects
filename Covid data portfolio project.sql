...
-- from other table we have to use
SELECT*
From PortfolioProject..CovidDeaths as dea
join Portfolioproject..covidvaccinationes as vac
ON dea.location=vac.location
and dea.date=vac.date

SELECT*
FROM Portfolioproject..covidvaccinationes
...
JOIN PortfolioProject..covidvaccinationes vac
...
Creaye view PercentPopulationVaccinated as
Select dea.continent, dea.location, dea.date, dea.population, vac.new_vaccinations
